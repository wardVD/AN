...
my $VERSION = sprintf "%d.%03d", q$Revision: 233069 $ =~ /(\d+)/g;
my $verbose;
...
#
   ...
   # \RCS$Revision: 233069 $
   # \RCS$Date: 2014-03-22 13:57:13 +0100 (Sat, 22 Mar 2014) $
   # \RCS$HeadURL: svn+ssh://svn.cern.ch/reps/tdr2/utils/trunk/general/makeManifest.pl $
   # \RCS$Id: makeManifest.pl 233069 2014-03-22 12:57:13Z alverson $
